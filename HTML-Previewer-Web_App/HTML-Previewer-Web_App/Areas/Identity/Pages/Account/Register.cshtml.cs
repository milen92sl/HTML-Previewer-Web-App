...
using static HTML_Previewer_Web_App.Data.DataConstants.User;
using static HTML_Previewer_Web_App.Areas.Identity.Pages.Account.Constants.ValidationErrorMessages;

namespace HTML_Previewer_Web_App.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
